// Divisional-chart (Varga) content libraries and personalized interpretation logic.
// Extracted from ChartPageContent for readability — pure data/logic, no React.
/* eslint-disable @typescript-eslint/no-explicit-any */

export const VARGA_DEFINITIONS: Record<string, { title: string, definition: string, tips: string }> = {
    'D1': {
...
export const VARGA_CATEGORIES: Record<string, string[]> = {
...
export const getPersonalizedInterpretation = (key: string, vargaData: any, userName: string = 'User') => {
    if (!vargaData) return [];
