var Swisseph = (() => {
    ...
    return (function (moduleArg = {}) {
        ...
        (() => {
            ...
            function loadPackage(metadata) {
                ...
                if (ENVIRONMENT_IS_NODE) {
                    ...
                    // Patched to avoid Webpack trying to bundle .data file
                    REMOTE_PACKAGE_BASE = "swisseph.data";
                }
        ...
        function findWasmBinary() {
            // Patched to avoid Webpack trying to bundle .wasm file
...
// Patched for CommonJS compatibility
